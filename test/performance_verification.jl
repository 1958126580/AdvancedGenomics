...
println("Benchmarking build_ibs_kernel...")
...
println("Benchmarking run_bayesA...")
...
println("Benchmarking run_bayesC...")
...
println("Benchmarking run_bayesB...")
...
println("Benchmarking run_bayesR...")
